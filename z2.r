#Задание 2
#Клюшина Ксения создайте модель множественной линейной регрессии потоков ночных потоков углекислого газа
...
vars = row.names(cor_td)[cor_td$co2_flux^2 > .1] %>% na.exclude; vars
